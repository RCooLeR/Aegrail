...
- [Browser Crawler And JavaScript Monitoring Plan](docs/collectors/browser-crawler.md): planned rendered-page crawler for script inventory, tag managers, and JavaScript drift.

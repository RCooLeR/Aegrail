	...
	return []ruleEvaluationCase{
		...
		},
		{
			fixture: RuleEvaluationFixture{
				...
				Kind:        "database_snapshot",
				Description: "A newly active PrestaShop module should produce a medium severity module finding.",
			},
			expected: []RuleEvaluationExpectedSignal{
				{ID: "prestashop-active-module-added", Severity: domain.SeverityMedium, Confidence: domain.ConfidenceHigh},
			},

...
func defaultRuleDefinitions() []RuleDefinition {
	ids := []string{
		...
		"prestashop-module-added",
		"prestashop-module-removed",
		"prestashop-module-upgraded",
		"prestashop-module-downgraded",
		"prestashop-module-version-changed",
		...
		"mautic-admin-user-added",
		"mautic-user-became-admin",
		"mautic-admin-user-removed",
		"mautic-user-access-changed",
		"mautic-user-entity-changed",
		"mautic-admin-role-changed",
		"mautic-role-permissions-changed",
		"mautic-plugin-added",
		"mautic-plugin-removed",
		"mautic-plugin-upgraded",
		"mautic-plugin-downgraded",
		"mautic-plugin-version-changed",
		"mautic-plugin-changed",
		"mautic-integration-credentials-changed",
		"mautic-integration-changed",
		"mautic-oauth-client-changed",
		"mautic-webhook-secret-changed",
		"mautic-webhook-changed",
		"mautic-database-entity-changed",
		"mautic-admin-roles-changed",
		"mautic-users-changed",
		"mautic-roles-changed",
		"mautic-database-check-changed",
		"yii2-rbac-admin-access-count-changed",
		"yii2-rbac-access-model-changed",
		"yii2-rbac-users-count-changed",
		"yii2-rbac-migrations-changed",
		"yii2-rbac-database-check-changed",
		"yii2-rbac-admin-user-added",
		"yii2-rbac-user-became-admin",
		"yii2-rbac-admin-user-removed",
		"yii2-rbac-user-access-changed",
		"yii2-rbac-user-changed",
		"yii2-rbac-admin-role-changed",
		"yii2-rbac-role-assignment-changed",
		"yii2-rbac-database-entity-changed",
		"laravel-admin-access-count-changed",
		"laravel-access-model-changed",
		"laravel-users-count-changed",
		"laravel-password-reset-tokens-changed",
		"laravel-sessions-changed",
		"laravel-migrations-changed",
		"laravel-database-check-changed",
		"laravel-admin-user-added",
		"laravel-user-became-admin",
		"laravel-admin-user-removed",
		"laravel-user-access-changed",
		"laravel-user-changed",
		"laravel-privileged-access-changed",
		"laravel-access-assignment-changed",
		"laravel-database-entity-changed",
...
func inferRuleDefinition(id string) RuleDefinition {
	...
	case strings.HasPrefix(id, "prestashop-"):
		...
		definition.EvidenceTypes = []string{"database"}
		definition.ActionHints = []RuleActionHint{RuleActionAcknowledge, RuleActionMarkFalsePositive, RuleActionInspectDatabase, RuleActionInspectTimeline, RuleActionInspectDeployment}
	case strings.HasPrefix(id, "mautic-"):
		definition.Category = RuleCategoryDatabaseSnapshot
		definition.Platforms = []string{"mautic"}
		definition.EvidenceTypes = []string{"database"}
		definition.ActionHints = []RuleActionHint{RuleActionAcknowledge, RuleActionMarkFalsePositive, RuleActionInspectDatabase, RuleActionInspectTimeline, RuleActionInspectDeployment}
	case strings.HasPrefix(id, "yii2-rbac-"):
		definition.Category = RuleCategoryDatabaseSnapshot
		definition.Platforms = []string{"yii2-rbac"}
		definition.EvidenceTypes = []string{"database"}
		definition.ActionHints = []RuleActionHint{RuleActionAcknowledge, RuleActionMarkFalsePositive, RuleActionInspectDatabase, RuleActionInspectTimeline, RuleActionInspectDeployment}
	case strings.HasPrefix(id, "laravel-"):
		definition.Category = RuleCategoryDatabaseSnapshot
		definition.Platforms = []string{"laravel"}
		definition.EvidenceTypes = []string{"database"}
		definition.ActionHints = []RuleActionHint{RuleActionAcknowledge, RuleActionMarkFalsePositive, RuleActionInspectDatabase, RuleActionInspectTimeline, RuleActionInspectDeployment}

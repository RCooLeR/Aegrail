...
type ModelAnalysisReportRepository interface {
	...
	ListModelAnalysisReportsForFinding(ctx context.Context, environmentID domain.ID, appID domain.ID, findingID domain.ID, limit int) ([]domain.ModelAnalysisReport, error)
	...
	FindLatestModelAnalysisReportByFinding(ctx context.Context, environmentID domain.ID, appID domain.ID, findingID domain.ID, promptTemplateID string, promptTemplateVersion string, modelName string) (domain.ModelAnalysisReport, bool, error)
}
